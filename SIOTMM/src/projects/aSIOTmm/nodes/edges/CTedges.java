...
public class CTedges extends BidirectionalEdge {
	...
	public void cleanUp() {
		...
		CustomGlobal.contacts_trace.logln("" + this.startNode.ID  + 
				", " + this.endNode.ID +
				", " + start_time +
				", " + end_time +
				", " + this.startNode.getPosition().xCoord +
				", " + this.startNode.getPosition().yCoord +
				", " + this.endNode.getPosition().xCoord +
				", " + this.endNode.getPosition().yCoord);
	}
